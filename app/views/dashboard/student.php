...
<body class="bg-gray-100">
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-8">Welcome to Your Dashboard, Student!</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="text-center">
                    ...
                    <a href="/student/my-courses" class="text-blue-500 hover:text-blue-700">View My Courses →</a>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="text-center">
                    ...
                    <a href="/courses" class="text-blue-500 hover:text-blue-700">Explore →</a>
                </div>
            </div>
        </div>
    </div>
